<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Js.ascx.cs" Inherits="nilnul._express_._compose_._WEB_.loader_._headed.Js" %>

<%-- 
	used in a page;

	the subject in the page is server rendered per the query par;
